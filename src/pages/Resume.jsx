    ...
    <div id="resume" className="container">
      ...
      <div className="resume__wrapper">
        <div className="resume__grid" data-aos="fade-up" data-aos-delay="500">
          ...
          <div>
            <div className="resume__name playfair">Haroon Hakimi</div>
            <div className="resume__title lato">Software Engineer</div>
            <div className="resume__contact--info">
              <div>
                <FaDownload />
                <a className="resume__link" href={MyResume} target="_blank">
                  Download resume
                </a>
              </div>
              <div>
                <MdEmail />
                <a className="resume__link" href="mailto:haroonhakimi2005@gmail.com">
                  Email
                </a>
              </div>
              <div>
          ...
          <div>
            <div className="resume__education--wrapper">
              <div className="resume__education">
                ...
                <div>
                Finished multiple virtual internships, involving building highly responsive and dynamic web apps.
                </div>
              </div>
              <div className="resume__job--date">2023</div>
            </div>
          </div>
        </div>
